		...
		<el-card>
			...
			<el-row class="menu-contain" v-if="showSearch">
				<el-form label-width="70px" :model="searchMenuFrom" class="menu-search">
					...
					<el-button size="mini" icon="el-icon-refresh" class="menu-reset-btns">重置</el-button>
				</el-form>
			</el-row>
			<!-- 新增按钮区域 -->
			<el-row class="btns">
			...
			<el-form :model="editMenuForm" label-width="80px" class="edit-menu-form">
				<el-row>
					<el-form-item label="上级菜单" prop="supermenu">
						<treeselect v-model="editMenuForm.superId" :multiple="true" :options="menuOptions" />
					</el-form-item>
				</el-row>
				<el-row>
				...
				<el-row>
					<el-form-item label="菜单图标" prop="icon">
						<el-popover placement="bottom-start" width="460" trigger="click">
							...
							<el-input slot="reference" placeholder="点击选择图标">
				...
				<el-row :gutter="12">
					<el-col :span="12">
						<el-form-item label="菜单名称" prop="" required>
							<el-input placeholder="请输入菜单名称" v-model="editMenuForm.menuName"></el-input>
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="显示排序" prop="" required>
							<el-input-number
				...
				<el-row :gutter="12">
					...
					<el-col :span="12">
						<el-form-item label="路由地址" prop="" required>
